...
from PyQt5.QtWidgets import QLabel, QPushButton, QWidget, QVBoxLayout, QHBoxLayout, QListWidget, QTableWidget, \
    QAbstractItemView, QSlider, QComboBox, QMessageBox, QTableWidgetItem, QLineEdit, QMenu, QGroupBox, QCheckBox, \
    QFileDialog, QMainWindow, QAction, qApp, QApplication, QDesktopWidget
...
# all={'like':[],'allmusic':[],'playlist':{},'musiclist':[],  'playingmusic':'',  'playmode':'随机播放', 'playingtime': 0,
# 'playhistory': {}, 'musicsec': 0,'volume'=1.0}
class ttt(QWidget):
