 /****************************************************************************
   ...
   * --------------------------------------------------------------------------
   * 2021-8-12    1.0.0    ShuJie     written
*****************************************************************************/
                                 ...
                                 char *pQrCodeFile, int *pZintRet)
{
    ...
    {
        if(strstr(pQrCodeFile, "png") || (strstr(pQrCodeFile, "eps")) \
           || (strstr(pQrCodeFile, "svg")))
        {
    ...
    pMySymbol->option_1   = 3; //ECC Level.It can be large when ECC Level is \
                                 larger.(value:1-4)  
    pMySymbol->scale        = 4; //contorl qrcode file size, default is 1, \
                                  used to be 4   
    pMySymbol->border_width = 2; //set white space width around your qrcode \
                                   and 0 is for nothing 
